...
public abstract class Motor : MonoBehaviour 
{
	...
	public float maximumAngularSpeed = 10;
	
	public float maximumAcceleration = 20;
	public float maximumAngularAcceleration = 20;
	
	public float gravity = 21;
	public float terminalVelocity = 20;
	
	public float linearGroundDamping = 0.02f;
	public float linearAirDamping = 0.005f;
	public float angularDamping = 0.02f;

	public Vector3? desiredLinear = Vector3.zero;
	public Vector3? desiredAngular = Vector3.zero;
	
    protected Vector3 linearVelocity = Vector3.zero;
	protected float fallingVelocity = 0;
	...
	protected abstract void IntegrateAngularVelocity();
